...
function func1() {
  return regeneratorRuntime.wrap(function func1$(_context) {
    while (1) {
...
var toISOString = __webpack_require__(212); // PhantomJS / old WebKit has a broken implementations
